...
class TestText(BaseTestCase):
    ...
    def test_valid_update_text(self): 
        with self.client: 
            ...
            response_update_text = self.client.put(
                ...
                data=json.dumps(dict(
                    text_title='updated test title',
                    text_body='updated hello world'
                    )),
                content_type='application/json'
            )
    ...
    def test_update_text_not_logged_in(self):
        with self.client:
            ...
            data_update_text = json.loads(response_update_text.data.decode())
            self.assertTrue(data_update_text['status'] == 'fail')
            self.assertTrue(data_update_text['message'] == 'Provide a valid auth token.')
    ...
    def test_delete_text(self): 
        with self.client: 
            ...
            self.assertTrue(data_delete_texts['message'] == 'Successfully deleted text.')
